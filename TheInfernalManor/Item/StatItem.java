...
public class StatItem extends Item implements GUIConstants
{
   ...
   public StatItem(String name, int icon, int color)
   {
      super(name, icon, color);
   }
   
   public StatItem(StatItem that)
   {
      super(that);
      this.add(that);
   }
   
   public void add(StatItem that)
   {
   ...
   public Vector<String> getComparisonSummary(StatItem that)
   {
      Vector<String> strList = new Vector<String>();
      String str = "";
      int val = 0;
   ...
   public boolean equals(StatItem that)
   {
   ...
   public String serialize()
   {
      ...
      str = str.replace("ITEM@", "STAT_ITEM@");
